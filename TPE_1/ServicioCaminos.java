...
public class ServicioCaminos{
    ...
    public List<List<Integer>> caminos(){
        ...
        ArrayList<Arco> arcosParciales = new ArrayList<Arco>();
    ...
    private void caminos(Integer vertice, LinkedList<Integer> listaParcial, ArrayList<Arco> arcosParciales){
            ...
            if(tieneAdyacentes(vertice)){
                ...
                while(it.hasNext()){
                    ...
                    if(!contieneArcos(arcosParciales, vertice, hijo)){
                        arcosParciales.add(grafo.obtenerArco(vertice, hijo));
                        contadorDeArcos++;
                        if(!this.poda()){
    ...
    private boolean contieneArcos(ArrayList<Arco> arcosParciales, Integer vertice, Integer hijo){
